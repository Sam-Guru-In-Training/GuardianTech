...
/**
 * Helper methods related to requesting and receiving news story data from the Guardian.
 */
public final class QueryUtils {
     ...
     */
    private static List<NewsStory> extractFeatureFromJson(String newsStoriesJSON) {
...
//                String url = properties.getString("url");
                ...
                NewsStory newsStory = new NewsStory(title, sectionName, articleType, date, url);
